...
#if !defined(VISUALS_BLINNPHONGMATERIALTECHNIQUE_H_INCLUDED)
#define VISUALS_BLINNPHONGMATERIALTECHNIQUE_H_INCLUDED

#include "Visuals/MaterialTechnique.h"

/// @brief
/// A material technique for "Blinn-Phong" technique.
/// @details
/// The type is
/// @code
/// class Visuals.BlinnPhongMaterialTechnique
/// @endcode
/// Its constructor is
/// @code
/// Visuals.BlinnPhongMaterialTechnique.construct()
/// @endcode
/// constructing the material technique with default values.
/// The default values are
/// - diffuse = ambient = specular = (85,85,85)
/// - shininesss = 230
Shizu_declareObjectType(Visuals_BlinnPhongMaterialTechnique);

struct Visuals_BlinnPhongMaterialTechnique {
...
struct Visuals_BlinnPhongMaterialTechnique_Dispatch {
...
#endif // VISUALS_BLINNPHONGMATERIALTECHNIQUE_H_INCLUDED
