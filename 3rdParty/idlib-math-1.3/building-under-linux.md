...
An out of source build is the recommended way of building *IdLib*.

- Checkout `zeitgeist` [https://github.com/michaelheilmann/zeitgeist.git](https://github.com/michaelheilmann/idlib.git) into a directory in your file system.
...
The above builds *IdLib* without debug information. To build *IdLib* with debug information add the parameter `-DCMAKE_BUILD_TYPE="Debug"` to the cmake command.
