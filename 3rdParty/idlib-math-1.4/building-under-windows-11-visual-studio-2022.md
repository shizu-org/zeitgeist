...
- Checkout `zeitgeist` [https://github.com/michaelheilmann/idlib.git](https://github.com/michaelheilmann/idlib.git) into a directory in your file system.
...
- The Visual Studio Community 2022 solution file `idlib.sln` should have been generated in `<build-directory>`.
